...
class ApiV1WorkspaceWorkspaceIdTrustedIpsPostRequest(BaseModel):
    """
    ...
    __properties = ["ipAddress", "comment", "isActive"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1WorkspaceWorkspaceIdTrustedIpsPostRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1WorkspaceWorkspaceIdTrustedIpsPostRequest:
        """Create an instance of ApiV1WorkspaceWorkspaceIdTrustedIpsPostRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1WorkspaceWorkspaceIdTrustedIpsPostRequest.parse_obj(obj)

        _obj = ApiV1WorkspaceWorkspaceIdTrustedIpsPostRequest.parse_obj({
