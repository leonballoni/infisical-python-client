...
class ApiV2UsersMeApiKeysPostRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV2UsersMeApiKeysPostRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV2UsersMeApiKeysPostRequest:
        """Create an instance of ApiV2UsersMeApiKeysPostRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV2UsersMeApiKeysPostRequest.parse_obj(obj)

        _obj = ApiV2UsersMeApiKeysPostRequest.parse_obj({
            "name": obj.get("name"),
