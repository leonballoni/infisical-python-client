...
class ApiV3SecretsBatchRawPost200ResponseAnyOf(BaseModel):
    """
    ApiV3SecretsBatchRawPost200ResponseAnyOf
    """
    secrets: Annotated[List[ApiV1SecretSecretIdSecretVersionsGet200ResponseSecretVersionsInner], Field()] = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV3SecretsBatchRawPost200ResponseAnyOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV3SecretsBatchRawPost200ResponseAnyOf:
        """Create an instance of ApiV3SecretsBatchRawPost200ResponseAnyOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV3SecretsBatchRawPost200ResponseAnyOf.parse_obj(obj)

        _obj = ApiV3SecretsBatchRawPost200ResponseAnyOf.parse_obj({
