...
class ApiV1ScimUsersGet200ResponseResourcesInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1ScimUsersGet200ResponseResourcesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1ScimUsersGet200ResponseResourcesInner:
        """Create an instance of ApiV1ScimUsersGet200ResponseResourcesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1ScimUsersGet200ResponseResourcesInner.parse_obj(obj)

        _obj = ApiV1ScimUsersGet200ResponseResourcesInner.parse_obj({
            "id": obj.get("id"),
