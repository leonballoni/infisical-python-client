...
class ApiV1WebhooksWebhookIdPatchRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1WebhooksWebhookIdPatchRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1WebhooksWebhookIdPatchRequest:
        """Create an instance of ApiV1WebhooksWebhookIdPatchRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1WebhooksWebhookIdPatchRequest.parse_obj(obj)

        _obj = ApiV1WebhooksWebhookIdPatchRequest.parse_obj({
