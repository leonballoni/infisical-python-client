...
class ApiV1AdditionalPrivilegeUsersPermanentPost200Response(BaseModel):
    """
    ApiV1AdditionalPrivilegeUsersPermanentPost200Response
    """
    privilege: ApiV1AdditionalPrivilegeUsersPermanentPost200ResponsePrivilege = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1AdditionalPrivilegeUsersPermanentPost200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1AdditionalPrivilegeUsersPermanentPost200Response:
        """Create an instance of ApiV1AdditionalPrivilegeUsersPermanentPost200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1AdditionalPrivilegeUsersPermanentPost200Response.parse_obj(obj)

        _obj = ApiV1AdditionalPrivilegeUsersPermanentPost200Response.parse_obj({
            "privilege": ApiV1AdditionalPrivilegeUsersPermanentPost200ResponsePrivilege.from_dict(obj.get("privilege")) if obj.get("privilege") is not None else None
        })
        return _obj
