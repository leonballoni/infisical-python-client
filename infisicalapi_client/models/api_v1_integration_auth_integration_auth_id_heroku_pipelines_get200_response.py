...
class ApiV1IntegrationAuthIntegrationAuthIdHerokuPipelinesGet200Response(BaseModel):
    """
    ApiV1IntegrationAuthIntegrationAuthIdHerokuPipelinesGet200Response
    """
    pipelines: Annotated[List[ApiV1IntegrationAuthIntegrationAuthIdHerokuPipelinesGet200ResponsePipelinesInner], Field()] = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1IntegrationAuthIntegrationAuthIdHerokuPipelinesGet200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1IntegrationAuthIntegrationAuthIdHerokuPipelinesGet200Response:
        """Create an instance of ApiV1IntegrationAuthIntegrationAuthIdHerokuPipelinesGet200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1IntegrationAuthIntegrationAuthIdHerokuPipelinesGet200Response.parse_obj(obj)

        _obj = ApiV1IntegrationAuthIntegrationAuthIdHerokuPipelinesGet200Response.parse_obj({
            "pipelines": [ApiV1IntegrationAuthIntegrationAuthIdHerokuPipelinesGet200ResponsePipelinesInner.from_dict(_item) for _item in obj.get("pipelines")] if obj.get("pipelines") is not None else None
        })
        return _obj
