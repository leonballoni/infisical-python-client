...
class ApiV1AuditLogStreamsIdPatchRequest(BaseModel):
    """
    ApiV1AuditLogStreamsIdPatchRequest
    """
    url: Optional[StrictStr] = Field(default=None, description="The HTTP URL to push logs to.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1AuditLogStreamsIdPatchRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1AuditLogStreamsIdPatchRequest:
        """Create an instance of ApiV1AuditLogStreamsIdPatchRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1AuditLogStreamsIdPatchRequest.parse_obj(obj)

        _obj = ApiV1AuditLogStreamsIdPatchRequest.parse_obj({
            "url": obj.get("url"),
