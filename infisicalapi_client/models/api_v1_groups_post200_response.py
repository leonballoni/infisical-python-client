...
class ApiV1GroupsPost200Response(BaseModel):
    """
    ...
    __properties = ["id", "orgId", "name", "slug", "role", "roleId", "createdAt", "updatedAt"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1GroupsPost200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1GroupsPost200Response:
        """Create an instance of ApiV1GroupsPost200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1GroupsPost200Response.parse_obj(obj)
