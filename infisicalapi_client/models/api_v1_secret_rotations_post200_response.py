...
class ApiV1SecretRotationsPost200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1SecretRotationsPost200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1SecretRotationsPost200Response:
        """Create an instance of ApiV1SecretRotationsPost200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1SecretRotationsPost200Response.parse_obj(obj)

        _obj = ApiV1SecretRotationsPost200Response.parse_obj({
            "secret_rotation": ApiV1SecretRotationsPost200ResponseSecretRotation.from_dict(obj.get("secretRotation")) if obj.get("secretRotation") is not None else None
        })
        return _obj
