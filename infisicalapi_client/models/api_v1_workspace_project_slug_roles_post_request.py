...
class ApiV1WorkspaceProjectSlugRolesPostRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1WorkspaceProjectSlugRolesPostRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1WorkspaceProjectSlugRolesPostRequest:
        """Create an instance of ApiV1WorkspaceProjectSlugRolesPostRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1WorkspaceProjectSlugRolesPostRequest.parse_obj(obj)

        _obj = ApiV1WorkspaceProjectSlugRolesPostRequest.parse_obj({
            "slug": obj.get("slug"),
            "name": obj.get("name"),
