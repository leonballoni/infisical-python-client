...
class ApiV1SecretApprovalRequestsIdMergePostRequest(BaseModel):
    """
    ApiV1SecretApprovalRequestsIdMergePostRequest
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1SecretApprovalRequestsIdMergePostRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1SecretApprovalRequestsIdMergePostRequest:
        """Create an instance of ApiV1SecretApprovalRequestsIdMergePostRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1SecretApprovalRequestsIdMergePostRequest.parse_obj(obj)

        _obj = ApiV1SecretApprovalRequestsIdMergePostRequest.parse_obj({
