...
class ApiV3SecretsGet200ResponseImportsInnerSecretsInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV3SecretsGet200ResponseImportsInnerSecretsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV3SecretsGet200ResponseImportsInnerSecretsInner:
        """Create an instance of ApiV3SecretsGet200ResponseImportsInnerSecretsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV3SecretsGet200ResponseImportsInnerSecretsInner.parse_obj(obj)

        _obj = ApiV3SecretsGet200ResponseImportsInnerSecretsInner.parse_obj({
            "id": obj.get("id"),
