...
class ApiV2WorkspaceProjectIdMembershipsPostRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV2WorkspaceProjectIdMembershipsPostRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV2WorkspaceProjectIdMembershipsPostRequest:
        """Create an instance of ApiV2WorkspaceProjectIdMembershipsPostRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV2WorkspaceProjectIdMembershipsPostRequest.parse_obj(obj)

        _obj = ApiV2WorkspaceProjectIdMembershipsPostRequest.parse_obj({
