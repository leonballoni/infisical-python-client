...
class ApiV1IntegrationIntegrationIdPatchRequestMetadata(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1IntegrationIntegrationIdPatchRequestMetadata:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1IntegrationIntegrationIdPatchRequestMetadata:
        """Create an instance of ApiV1IntegrationIntegrationIdPatchRequestMetadata from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1IntegrationIntegrationIdPatchRequestMetadata.parse_obj(obj)

        _obj = ApiV1IntegrationIntegrationIdPatchRequestMetadata.parse_obj({
