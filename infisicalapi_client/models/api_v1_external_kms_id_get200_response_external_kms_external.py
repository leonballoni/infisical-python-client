...
class ApiV1ExternalKmsIdGet200ResponseExternalKmsExternal(BaseModel):
    """
    ...
    provider_input: ApiV1ExternalKmsPostRequestProviderInputs = Field(default=..., alias="providerInput")
    __properties = ["id", "status", "statusDetails", "provider", "providerInput"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1ExternalKmsIdGet200ResponseExternalKmsExternal:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1ExternalKmsIdGet200ResponseExternalKmsExternal:
        """Create an instance of ApiV1ExternalKmsIdGet200ResponseExternalKmsExternal from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1ExternalKmsIdGet200ResponseExternalKmsExternal.parse_obj(obj)

        _obj = ApiV1ExternalKmsIdGet200ResponseExternalKmsExternal.parse_obj({
            "id": obj.get("id"),
            "status": obj.get("status"),
            "status_details": obj.get("statusDetails"),
            "provider": obj.get("provider"),
            "provider_input": ApiV1ExternalKmsPostRequestProviderInputs.from_dict(obj.get("providerInput")) if obj.get("providerInput") is not None else None
        })
        return _obj
