...
class ApiV1ScimUsersGet200Response(BaseModel):
    """
    ApiV1ScimUsersGet200Response
    """
    resources: Annotated[List[ApiV1ScimUsersGet200ResponseResourcesInner], Field()] = Field(default=..., alias="Resources")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1ScimUsersGet200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1ScimUsersGet200Response:
        """Create an instance of ApiV1ScimUsersGet200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1ScimUsersGet200Response.parse_obj(obj)

        _obj = ApiV1ScimUsersGet200Response.parse_obj({
            "resources": [ApiV1ScimUsersGet200ResponseResourcesInner.from_dict(_item) for _item in obj.get("Resources")] if obj.get("Resources") is not None else None,
