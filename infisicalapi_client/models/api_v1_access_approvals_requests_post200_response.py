...
class ApiV1AccessApprovalsRequestsPost200Response(BaseModel):
    """
    ApiV1AccessApprovalsRequestsPost200Response
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1AccessApprovalsRequestsPost200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1AccessApprovalsRequestsPost200Response:
        """Create an instance of ApiV1AccessApprovalsRequestsPost200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1AccessApprovalsRequestsPost200Response.parse_obj(obj)

        _obj = ApiV1AccessApprovalsRequestsPost200Response.parse_obj({
            "approval": ApiV1AccessApprovalsRequestsPost200ResponseApproval.from_dict(obj.get("approval")) if obj.get("approval") is not None else None
        })
        return _obj
