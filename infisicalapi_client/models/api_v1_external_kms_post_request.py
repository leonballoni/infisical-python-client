...
class ApiV1ExternalKmsPostRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1ExternalKmsPostRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1ExternalKmsPostRequest:
        """Create an instance of ApiV1ExternalKmsPostRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1ExternalKmsPostRequest.parse_obj(obj)

        _obj = ApiV1ExternalKmsPostRequest.parse_obj({
            "slug": obj.get("slug"),
            "description": obj.get("description"),
            "provider": ApiV1ExternalKmsPostRequestProvider.from_dict(obj.get("provider")) if obj.get("provider") is not None else None
        })
        return _obj
