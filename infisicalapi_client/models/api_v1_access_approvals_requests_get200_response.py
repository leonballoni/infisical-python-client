...
class ApiV1AccessApprovalsRequestsGet200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1AccessApprovalsRequestsGet200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1AccessApprovalsRequestsGet200Response:
        """Create an instance of ApiV1AccessApprovalsRequestsGet200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1AccessApprovalsRequestsGet200Response.parse_obj(obj)

        _obj = ApiV1AccessApprovalsRequestsGet200Response.parse_obj({
            "requests": [ApiV1AccessApprovalsRequestsGet200ResponseRequestsInner.from_dict(_item) for _item in obj.get("requests")] if obj.get("requests") is not None else None
        })
        return _obj
