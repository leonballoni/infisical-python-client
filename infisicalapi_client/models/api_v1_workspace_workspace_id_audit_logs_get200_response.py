...
class ApiV1WorkspaceWorkspaceIdAuditLogsGet200Response(BaseModel):
    """
    ApiV1WorkspaceWorkspaceIdAuditLogsGet200Response
    """
    audit_logs: Annotated[List[ApiV1WorkspaceWorkspaceIdAuditLogsGet200ResponseAuditLogsInner], Field()] = Field(default=..., alias="auditLogs")
    __properties = ["auditLogs"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1WorkspaceWorkspaceIdAuditLogsGet200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1WorkspaceWorkspaceIdAuditLogsGet200Response:
        """Create an instance of ApiV1WorkspaceWorkspaceIdAuditLogsGet200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1WorkspaceWorkspaceIdAuditLogsGet200Response.parse_obj(obj)

        _obj = ApiV1WorkspaceWorkspaceIdAuditLogsGet200Response.parse_obj({
            "audit_logs": [ApiV1WorkspaceWorkspaceIdAuditLogsGet200ResponseAuditLogsInner.from_dict(_item) for _item in obj.get("auditLogs")] if obj.get("auditLogs") is not None else None
        })
        return _obj
