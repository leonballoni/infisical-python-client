...
class ApiV1AccessApprovalsPoliciesGet200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1AccessApprovalsPoliciesGet200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1AccessApprovalsPoliciesGet200Response:
        """Create an instance of ApiV1AccessApprovalsPoliciesGet200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1AccessApprovalsPoliciesGet200Response.parse_obj(obj)

        _obj = ApiV1AccessApprovalsPoliciesGet200Response.parse_obj({
            "approvals": [ApiV1AccessApprovalsPoliciesGet200ResponseApprovalsInner.from_dict(_item) for _item in obj.get("approvals")] if obj.get("approvals") is not None else None
        })
        return _obj
