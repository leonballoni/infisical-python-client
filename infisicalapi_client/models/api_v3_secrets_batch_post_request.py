...
class ApiV3SecretsBatchPostRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV3SecretsBatchPostRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV3SecretsBatchPostRequest:
        """Create an instance of ApiV3SecretsBatchPostRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV3SecretsBatchPostRequest.parse_obj(obj)

        _obj = ApiV3SecretsBatchPostRequest.parse_obj({
            "workspace_id": obj.get("workspaceId"),
            "environment": obj.get("environment"),
            "secret_path": obj.get("secretPath") if obj.get("secretPath") is not None else '/',
            "secrets": [ApiV3SecretsBatchPostRequestSecretsInner.from_dict(_item) for _item in obj.get("secrets")] if obj.get("secrets") is not None else None
        })
        return _obj
