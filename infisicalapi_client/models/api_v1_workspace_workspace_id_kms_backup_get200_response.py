...
class ApiV1WorkspaceWorkspaceIdKmsBackupGet200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1WorkspaceWorkspaceIdKmsBackupGet200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1WorkspaceWorkspaceIdKmsBackupGet200Response:
        """Create an instance of ApiV1WorkspaceWorkspaceIdKmsBackupGet200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1WorkspaceWorkspaceIdKmsBackupGet200Response.parse_obj(obj)

        _obj = ApiV1WorkspaceWorkspaceIdKmsBackupGet200Response.parse_obj({
            "secret_manager": obj.get("secretManager")
        })
        return _obj
