...
class ApiV3SecretsBatchPostRequestSecretsInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV3SecretsBatchPostRequestSecretsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV3SecretsBatchPostRequestSecretsInner:
        """Create an instance of ApiV3SecretsBatchPostRequestSecretsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV3SecretsBatchPostRequestSecretsInner.parse_obj(obj)

        _obj = ApiV3SecretsBatchPostRequestSecretsInner.parse_obj({
