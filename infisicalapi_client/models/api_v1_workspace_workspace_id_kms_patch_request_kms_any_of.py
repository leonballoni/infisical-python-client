...
class ApiV1WorkspaceWorkspaceIdKmsPatchRequestKmsAnyOf(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1WorkspaceWorkspaceIdKmsPatchRequestKmsAnyOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1WorkspaceWorkspaceIdKmsPatchRequestKmsAnyOf:
        """Create an instance of ApiV1WorkspaceWorkspaceIdKmsPatchRequestKmsAnyOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1WorkspaceWorkspaceIdKmsPatchRequestKmsAnyOf.parse_obj(obj)

        _obj = ApiV1WorkspaceWorkspaceIdKmsPatchRequestKmsAnyOf.parse_obj({
            "type": obj.get("type")
        })
        return _obj
