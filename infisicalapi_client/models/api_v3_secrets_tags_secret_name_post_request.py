...
class ApiV3SecretsTagsSecretNamePostRequest(BaseModel):
    """
    ...
    secret_path: Optional[StrictStr] = Field(default='/', alias="secretPath", description="The path of the secret to attach tags to.")
    type: Optional[StrictStr] = Field(default='shared', description="The type of the secret to attach tags to. (shared/personal)")
    tag_slugs: Annotated[List[StrictStr], Field(min_length=1)] = Field(default=..., alias="tagSlugs", description="An array of existing tag slugs to attach to the secret.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV3SecretsTagsSecretNamePostRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV3SecretsTagsSecretNamePostRequest:
        """Create an instance of ApiV3SecretsTagsSecretNamePostRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV3SecretsTagsSecretNamePostRequest.parse_obj(obj)

        _obj = ApiV3SecretsTagsSecretNamePostRequest.parse_obj({
