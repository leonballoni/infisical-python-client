...
class ApiV1ScimGroupsPost200Response(BaseModel):
    """
    ...
    members: Optional[Annotated[List[ApiV1ScimUsersOrgMembershipIdGet201ResponseGroupsInner], Field()]] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1ScimGroupsPost200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1ScimGroupsPost200Response:
        """Create an instance of ApiV1ScimGroupsPost200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1ScimGroupsPost200Response.parse_obj(obj)

        _obj = ApiV1ScimGroupsPost200Response.parse_obj({
