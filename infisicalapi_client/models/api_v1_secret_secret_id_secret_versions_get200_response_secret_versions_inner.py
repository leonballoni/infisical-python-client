...
class ApiV1SecretSecretIdSecretVersionsGet200ResponseSecretVersionsInner(BaseModel):
    """
    ...
    __properties = ["id", "_id", "workspace", "environment", "version", "type", "secretKey", "secretValue", "secretComment", "secretReminderNote", "secretReminderRepeatDays", "skipMultilineEncoding", "metadata", "createdAt", "updatedAt"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1SecretSecretIdSecretVersionsGet200ResponseSecretVersionsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1SecretSecretIdSecretVersionsGet200ResponseSecretVersionsInner:
        """Create an instance of ApiV1SecretSecretIdSecretVersionsGet200ResponseSecretVersionsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1SecretSecretIdSecretVersionsGet200ResponseSecretVersionsInner.parse_obj(obj)

        _obj = ApiV1SecretSecretIdSecretVersionsGet200ResponseSecretVersionsInner.parse_obj({
            "id": obj.get("id"),
            "id": obj.get("_id"),
