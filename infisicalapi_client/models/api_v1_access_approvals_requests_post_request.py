...
class ApiV1AccessApprovalsRequestsPostRequest(BaseModel):
    """
    ...
    __properties = ["permissions", "isTemporary", "temporaryRange"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1AccessApprovalsRequestsPostRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1AccessApprovalsRequestsPostRequest:
        """Create an instance of ApiV1AccessApprovalsRequestsPostRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1AccessApprovalsRequestsPostRequest.parse_obj(obj)

        _obj = ApiV1AccessApprovalsRequestsPostRequest.parse_obj({
