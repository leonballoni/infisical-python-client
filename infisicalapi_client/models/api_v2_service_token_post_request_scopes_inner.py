...
class ApiV2ServiceTokenPostRequestScopesInner(BaseModel):
    """
    ApiV2ServiceTokenPostRequestScopesInner
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV2ServiceTokenPostRequestScopesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV2ServiceTokenPostRequestScopesInner:
        """Create an instance of ApiV2ServiceTokenPostRequestScopesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV2ServiceTokenPostRequestScopesInner.parse_obj(obj)

        _obj = ApiV2ServiceTokenPostRequestScopesInner.parse_obj({
