...
class ApiV1SecretApprovalRequestsCountGet200Response(BaseModel):
    """
    ApiV1SecretApprovalRequestsCountGet200Response
    """
    approvals: ApiV1SecretApprovalRequestsCountGet200ResponseApprovals = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1SecretApprovalRequestsCountGet200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1SecretApprovalRequestsCountGet200Response:
        """Create an instance of ApiV1SecretApprovalRequestsCountGet200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1SecretApprovalRequestsCountGet200Response.parse_obj(obj)

        _obj = ApiV1SecretApprovalRequestsCountGet200Response.parse_obj({
            "approvals": ApiV1SecretApprovalRequestsCountGet200ResponseApprovals.from_dict(obj.get("approvals")) if obj.get("approvals") is not None else None
        })
        return _obj
