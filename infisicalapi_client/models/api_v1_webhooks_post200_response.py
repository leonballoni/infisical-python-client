...
class ApiV1WebhooksPost200Response(BaseModel):
    """
    ApiV1WebhooksPost200Response
    """
    message: StrictStr = Field(...)
    webhook: ApiV1WebhooksPost200ResponseWebhook = Field(...)
    __properties = ["message", "webhook"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1WebhooksPost200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1WebhooksPost200Response:
        """Create an instance of ApiV1WebhooksPost200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1WebhooksPost200Response.parse_obj(obj)

        _obj = ApiV1WebhooksPost200Response.parse_obj({
            "message": obj.get("message"),
            "webhook": ApiV1WebhooksPost200ResponseWebhook.from_dict(obj.get("webhook")) if obj.get("webhook") is not None else None
        })
        return _obj
