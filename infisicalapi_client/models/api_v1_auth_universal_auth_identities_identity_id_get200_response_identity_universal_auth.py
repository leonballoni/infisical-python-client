...
class ApiV1AuthUniversalAuthIdentitiesIdentityIdGet200ResponseIdentityUniversalAuth(BaseModel):
    """
    ...
    client_secret_trusted_ips: Optional[Any] = Field(default=None, alias="clientSecretTrustedIps")
    ...
    __properties = ["id", "clientId", "accessTokenTTL", "accessTokenMaxTTL", "accessTokenNumUsesLimit", "clientSecretTrustedIps", "accessTokenTrustedIps", "createdAt", "updatedAt", "identityId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1AuthUniversalAuthIdentitiesIdentityIdGet200ResponseIdentityUniversalAuth:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # set to None if client_secret_trusted_ips (nullable) is None
        # and __fields_set__ contains the field
        if self.client_secret_trusted_ips is None and "client_secret_trusted_ips" in self.__fields_set__:
            _dict['clientSecretTrustedIps'] = None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1AuthUniversalAuthIdentitiesIdentityIdGet200ResponseIdentityUniversalAuth:
        """Create an instance of ApiV1AuthUniversalAuthIdentitiesIdentityIdGet200ResponseIdentityUniversalAuth from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1AuthUniversalAuthIdentitiesIdentityIdGet200ResponseIdentityUniversalAuth.parse_obj(obj)

        _obj = ApiV1AuthUniversalAuthIdentitiesIdentityIdGet200ResponseIdentityUniversalAuth.parse_obj({
            "id": obj.get("id"),
            ...
            "client_secret_trusted_ips": obj.get("clientSecretTrustedIps"),
