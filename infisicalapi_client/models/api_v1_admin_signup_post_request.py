...
class ApiV1AdminSignupPostRequest(BaseModel):
    """
    ...
    __properties = ["email", "password", "firstName", "lastName", "protectedKey", "protectedKeyIV", "protectedKeyTag", "publicKey", "encryptedPrivateKey", "encryptedPrivateKeyIV", "encryptedPrivateKeyTag", "salt", "verifier"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1AdminSignupPostRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1AdminSignupPostRequest:
        """Create an instance of ApiV1AdminSignupPostRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1AdminSignupPostRequest.parse_obj(obj)

        _obj = ApiV1AdminSignupPostRequest.parse_obj({
            "email": obj.get("email"),
