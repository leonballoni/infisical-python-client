...
class ApiV1OrganizationOrganizationIdPermissionsGet200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1OrganizationOrganizationIdPermissionsGet200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1OrganizationOrganizationIdPermissionsGet200Response:
        """Create an instance of ApiV1OrganizationOrganizationIdPermissionsGet200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1OrganizationOrganizationIdPermissionsGet200Response.parse_obj(obj)

        _obj = ApiV1OrganizationOrganizationIdPermissionsGet200Response.parse_obj({
