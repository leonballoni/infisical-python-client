...
class ApiV1SecretSnapshotSecretSnapshotIdGet200ResponseSecretSnapshot(BaseModel):
    ...
    secret_versions: Annotated[List[ApiV1SecretSnapshotSecretSnapshotIdGet200ResponseSecretSnapshotSecretVersionsInner], Field()] = Field(default=..., alias="secretVersions")
    folder_version: Annotated[List[ApiV1SecretSnapshotSecretSnapshotIdGet200ResponseSecretSnapshotFolderVersionInner], Field()] = Field(default=..., alias="folderVersion")
