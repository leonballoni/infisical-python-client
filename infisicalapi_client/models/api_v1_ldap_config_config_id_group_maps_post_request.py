...
class ApiV1LdapConfigConfigIdGroupMapsPostRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1LdapConfigConfigIdGroupMapsPostRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1LdapConfigConfigIdGroupMapsPostRequest:
        """Create an instance of ApiV1LdapConfigConfigIdGroupMapsPostRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1LdapConfigConfigIdGroupMapsPostRequest.parse_obj(obj)

        _obj = ApiV1LdapConfigConfigIdGroupMapsPostRequest.parse_obj({
            "ldap_group_cn": obj.get("ldapGroupCN"),
            "group_slug": obj.get("groupSlug")
        })
        return _obj
