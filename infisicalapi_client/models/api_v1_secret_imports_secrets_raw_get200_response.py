...
class ApiV1SecretImportsSecretsRawGet200Response(BaseModel):
    """
    ApiV1SecretImportsSecretsRawGet200Response
    """
    secrets: Annotated[List[ApiV1SecretImportsSecretsRawGet200ResponseSecretsInner], Field()] = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1SecretImportsSecretsRawGet200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1SecretImportsSecretsRawGet200Response:
        """Create an instance of ApiV1SecretImportsSecretsRawGet200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1SecretImportsSecretsRawGet200Response.parse_obj(obj)

        _obj = ApiV1SecretImportsSecretsRawGet200Response.parse_obj({
            "secrets": [ApiV1SecretImportsSecretsRawGet200ResponseSecretsInner.from_dict(_item) for _item in obj.get("secrets")] if obj.get("secrets") is not None else None
        })
        return _obj
