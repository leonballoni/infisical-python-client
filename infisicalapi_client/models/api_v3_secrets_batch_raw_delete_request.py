...
class ApiV3SecretsBatchRawDeleteRequest(BaseModel):
    """
    ...
    secret_path: Optional[StrictStr] = Field(default='/', alias="secretPath", description="The path of the secret.")
    secrets: Annotated[List[ApiV3SecretsBatchRawDeleteRequestSecretsInner], Field(min_length=1)] = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV3SecretsBatchRawDeleteRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV3SecretsBatchRawDeleteRequest:
        """Create an instance of ApiV3SecretsBatchRawDeleteRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV3SecretsBatchRawDeleteRequest.parse_obj(obj)

        _obj = ApiV3SecretsBatchRawDeleteRequest.parse_obj({
            ...
            "secrets": [ApiV3SecretsBatchRawDeleteRequestSecretsInner.from_dict(_item) for _item in obj.get("secrets")] if obj.get("secrets") is not None else None
        })
        return _obj
