...
class ApiV3SecretsRawSecretNameGet200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV3SecretsRawSecretNameGet200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV3SecretsRawSecretNameGet200Response:
        """Create an instance of ApiV3SecretsRawSecretNameGet200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV3SecretsRawSecretNameGet200Response.parse_obj(obj)

        _obj = ApiV3SecretsRawSecretNameGet200Response.parse_obj({
            "secret": ApiV3SecretsRawSecretNameGet200ResponseSecret.from_dict(obj.get("secret")) if obj.get("secret") is not None else None
        })
        return _obj
