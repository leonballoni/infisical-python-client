...
class ApiV1PasswordEmailPasswordResetVerifyPost200Response(BaseModel):
    """
    ...
    __properties = ["message", "user", "token"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1PasswordEmailPasswordResetVerifyPost200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1PasswordEmailPasswordResetVerifyPost200Response:
        """Create an instance of ApiV1PasswordEmailPasswordResetVerifyPost200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1PasswordEmailPasswordResetVerifyPost200Response.parse_obj(obj)

        _obj = ApiV1PasswordEmailPasswordResetVerifyPost200Response.parse_obj({
