...
class ApiV1IntegrationPost200Response(BaseModel):
    ...
    """
    integration: ApiV1IntegrationPost200ResponseIntegration = Field(...)
    __properties = ["integration"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1IntegrationPost200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1IntegrationPost200Response:
        """Create an instance of ApiV1IntegrationPost200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1IntegrationPost200Response.parse_obj(obj)

        _obj = ApiV1IntegrationPost200Response.parse_obj({
            "integration": ApiV1IntegrationPost200ResponseIntegration.from_dict(obj.get("integration")) if obj.get("integration") is not None else None
        })
        return _obj
