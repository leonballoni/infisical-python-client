...
class ApiV2WorkspaceProjectIdMembershipsDeleteRequest(BaseModel):
    ...
    """
    emails: Optional[Annotated[List[StrictStr], Field()]] = Field(default=None, description="A list of organization member emails to remove from the project.")
    usernames: Optional[Annotated[List[StrictStr], Field()]] = Field(default=None, description="A list of usernames to remove from the project.")
