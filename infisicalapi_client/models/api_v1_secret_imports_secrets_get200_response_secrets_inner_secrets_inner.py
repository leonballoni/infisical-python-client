...
class ApiV1SecretImportsSecretsGet200ResponseSecretsInnerSecretsInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1SecretImportsSecretsGet200ResponseSecretsInnerSecretsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1SecretImportsSecretsGet200ResponseSecretsInnerSecretsInner:
        """Create an instance of ApiV1SecretImportsSecretsGet200ResponseSecretsInnerSecretsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1SecretImportsSecretsGet200ResponseSecretsInnerSecretsInner.parse_obj(obj)
