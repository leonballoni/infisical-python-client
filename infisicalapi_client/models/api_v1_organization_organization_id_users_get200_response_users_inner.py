...
class ApiV1OrganizationOrganizationIdUsersGet200ResponseUsersInner(BaseModel):
    """
    ...
    user: ApiV1OrganizationOrganizationIdUsersGet200ResponseUsersInnerUser = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1OrganizationOrganizationIdUsersGet200ResponseUsersInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1OrganizationOrganizationIdUsersGet200ResponseUsersInner:
        """Create an instance of ApiV1OrganizationOrganizationIdUsersGet200ResponseUsersInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1OrganizationOrganizationIdUsersGet200ResponseUsersInner.parse_obj(obj)

        _obj = ApiV1OrganizationOrganizationIdUsersGet200ResponseUsersInner.parse_obj({
            "id": obj.get("id"),
            "role": obj.get("role"),
            ...
            "user": ApiV1OrganizationOrganizationIdUsersGet200ResponseUsersInnerUser.from_dict(obj.get("user")) if obj.get("user") is not None else None
        })
        return _obj
