...
class ApiV3SecretsBatchPatchRequest(BaseModel):
    ...
    secrets: Annotated[List[ApiV3SecretsBatchPatchRequestSecretsInner], Field(min_length=1)] = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV3SecretsBatchPatchRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV3SecretsBatchPatchRequest:
        """Create an instance of ApiV3SecretsBatchPatchRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV3SecretsBatchPatchRequest.parse_obj(obj)

        _obj = ApiV3SecretsBatchPatchRequest.parse_obj({
            "workspace_id": obj.get("workspaceId"),
            "environment": obj.get("environment"),
            "secret_path": obj.get("secretPath") if obj.get("secretPath") is not None else '/',
            "secrets": [ApiV3SecretsBatchPatchRequestSecretsInner.from_dict(_item) for _item in obj.get("secrets")] if obj.get("secrets") is not None else None
        })
        return _obj
