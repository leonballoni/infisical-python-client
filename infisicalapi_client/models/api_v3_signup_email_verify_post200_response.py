...
class ApiV3SignupEmailVerifyPost200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV3SignupEmailVerifyPost200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV3SignupEmailVerifyPost200Response:
        """Create an instance of ApiV3SignupEmailVerifyPost200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV3SignupEmailVerifyPost200Response.parse_obj(obj)

        _obj = ApiV3SignupEmailVerifyPost200Response.parse_obj({
