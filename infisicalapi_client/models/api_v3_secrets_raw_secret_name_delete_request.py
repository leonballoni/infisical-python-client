...
class ApiV3SecretsRawSecretNameDeleteRequest(BaseModel):
    """
    ApiV3SecretsRawSecretNameDeleteRequest
    """
    workspace_id: StrictStr = Field(default=..., alias="workspaceId", description="The ID of the project where the secret is located.")
    ...
    type: Optional[StrictStr] = Field(default='shared', description="The type of the secret to delete.")
    __properties = ["workspaceId", "environment", "secretPath", "type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV3SecretsRawSecretNameDeleteRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV3SecretsRawSecretNameDeleteRequest:
        """Create an instance of ApiV3SecretsRawSecretNameDeleteRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV3SecretsRawSecretNameDeleteRequest.parse_obj(obj)
