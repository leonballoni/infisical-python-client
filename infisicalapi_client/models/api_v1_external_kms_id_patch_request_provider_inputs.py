...
class ApiV1ExternalKmsIdPatchRequestProviderInputs(BaseModel):
    """
    ApiV1ExternalKmsIdPatchRequestProviderInputs
    """
    credential: Optional[ApiV1ExternalKmsPostRequestProviderInputsCredential] = None
    aws_region: Optional[Annotated[str, StringConstraints(strict=True, min_length=1)]] = Field(default=None, alias="awsRegion", description="AWS region to connect")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1ExternalKmsIdPatchRequestProviderInputs:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1ExternalKmsIdPatchRequestProviderInputs:
        """Create an instance of ApiV1ExternalKmsIdPatchRequestProviderInputs from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1ExternalKmsIdPatchRequestProviderInputs.parse_obj(obj)

        _obj = ApiV1ExternalKmsIdPatchRequestProviderInputs.parse_obj({
