...
class ApiV1WorkspaceWorkspaceIdPatch200Response(BaseModel):
    """
    ApiV1WorkspaceWorkspaceIdPatch200Response
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1WorkspaceWorkspaceIdPatch200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1WorkspaceWorkspaceIdPatch200Response:
        """Create an instance of ApiV1WorkspaceWorkspaceIdPatch200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1WorkspaceWorkspaceIdPatch200Response.parse_obj(obj)

        _obj = ApiV1WorkspaceWorkspaceIdPatch200Response.parse_obj({
