...
class ApiV1ExternalKmsIdPatchRequestProvider(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1ExternalKmsIdPatchRequestProvider:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1ExternalKmsIdPatchRequestProvider:
        """Create an instance of ApiV1ExternalKmsIdPatchRequestProvider from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1ExternalKmsIdPatchRequestProvider.parse_obj(obj)

        _obj = ApiV1ExternalKmsIdPatchRequestProvider.parse_obj({
            "type": obj.get("type"),
            "inputs": ApiV1ExternalKmsIdPatchRequestProviderInputs.from_dict(obj.get("inputs")) if obj.get("inputs") is not None else None
        })
        return _obj
