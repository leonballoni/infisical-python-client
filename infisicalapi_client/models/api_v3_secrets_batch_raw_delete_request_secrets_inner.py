...
class ApiV3SecretsBatchRawDeleteRequestSecretsInner(BaseModel):
    ...
    """
    secret_key: StrictStr = Field(default=..., alias="secretKey", description="The name of the secret to delete.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV3SecretsBatchRawDeleteRequestSecretsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV3SecretsBatchRawDeleteRequestSecretsInner:
        """Create an instance of ApiV3SecretsBatchRawDeleteRequestSecretsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV3SecretsBatchRawDeleteRequestSecretsInner.parse_obj(obj)

        _obj = ApiV3SecretsBatchRawDeleteRequestSecretsInner.parse_obj({
