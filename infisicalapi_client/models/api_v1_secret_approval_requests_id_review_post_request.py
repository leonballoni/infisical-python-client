...
class ApiV1SecretApprovalRequestsIdReviewPostRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1SecretApprovalRequestsIdReviewPostRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1SecretApprovalRequestsIdReviewPostRequest:
        """Create an instance of ApiV1SecretApprovalRequestsIdReviewPostRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1SecretApprovalRequestsIdReviewPostRequest.parse_obj(obj)

        _obj = ApiV1SecretApprovalRequestsIdReviewPostRequest.parse_obj({
