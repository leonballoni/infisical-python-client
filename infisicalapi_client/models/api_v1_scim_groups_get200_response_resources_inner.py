...
class ApiV1ScimGroupsGet200ResponseResourcesInner(BaseModel):
    """
    ...
    members: Annotated[List[ApiV1ScimUsersOrgMembershipIdGet201ResponseGroupsInner], Field()] = Field(...)
    meta: ApiV1ScimGroupsGet200ResponseResourcesInnerMeta = Field(...)
    __properties = ["schemas", "id", "displayName", "members", "meta"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1ScimGroupsGet200ResponseResourcesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1ScimGroupsGet200ResponseResourcesInner:
        """Create an instance of ApiV1ScimGroupsGet200ResponseResourcesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1ScimGroupsGet200ResponseResourcesInner.parse_obj(obj)

        _obj = ApiV1ScimGroupsGet200ResponseResourcesInner.parse_obj({
            ...
            "meta": ApiV1ScimGroupsGet200ResponseResourcesInnerMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None
        })
        return _obj
