...
class ApiV1AdditionalPrivilegeUsersPermanentPost200ResponsePrivilege(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1AdditionalPrivilegeUsersPermanentPost200ResponsePrivilege:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1AdditionalPrivilegeUsersPermanentPost200ResponsePrivilege:
        """Create an instance of ApiV1AdditionalPrivilegeUsersPermanentPost200ResponsePrivilege from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1AdditionalPrivilegeUsersPermanentPost200ResponsePrivilege.parse_obj(obj)

        _obj = ApiV1AdditionalPrivilegeUsersPermanentPost200ResponsePrivilege.parse_obj({
            "id": obj.get("id"),
            "slug": obj.get("slug"),
