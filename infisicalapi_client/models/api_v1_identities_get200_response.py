...
class ApiV1IdentitiesGet200Response(BaseModel):
    """
    ApiV1IdentitiesGet200Response
    """
    identities: Annotated[List[ApiV1IdentitiesGet200ResponseIdentitiesInner], Field()] = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1IdentitiesGet200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1IdentitiesGet200Response:
        """Create an instance of ApiV1IdentitiesGet200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1IdentitiesGet200Response.parse_obj(obj)

        _obj = ApiV1IdentitiesGet200Response.parse_obj({
            "identities": [ApiV1IdentitiesGet200ResponseIdentitiesInner.from_dict(_item) for _item in obj.get("identities")] if obj.get("identities") is not None else None
        })
        return _obj
