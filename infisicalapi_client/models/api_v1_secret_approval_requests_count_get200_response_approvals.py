...
class ApiV1SecretApprovalRequestsCountGet200ResponseApprovals(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1SecretApprovalRequestsCountGet200ResponseApprovals:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1SecretApprovalRequestsCountGet200ResponseApprovals:
        """Create an instance of ApiV1SecretApprovalRequestsCountGet200ResponseApprovals from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1SecretApprovalRequestsCountGet200ResponseApprovals.parse_obj(obj)

        _obj = ApiV1SecretApprovalRequestsCountGet200ResponseApprovals.parse_obj({
            "open": obj.get("open") if obj.get("open") is not None else 0,
            "closed": obj.get("closed") if obj.get("closed") is not None else 0
        })
        return _obj
