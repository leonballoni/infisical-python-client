...
class ApiV1SsoOidcConfigPost200Response(BaseModel):
    """
    ...
    __properties = ["id", "issuer", "authorizationEndpoint", "configurationType", "discoveryURL", "jwksUri", "tokenEndpoint", "userinfoEndpoint", "orgId", "isActive", "allowedEmailDomains"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1SsoOidcConfigPost200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1SsoOidcConfigPost200Response:
        """Create an instance of ApiV1SsoOidcConfigPost200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1SsoOidcConfigPost200Response.parse_obj(obj)

        _obj = ApiV1SsoOidcConfigPost200Response.parse_obj({
            "id": obj.get("id"),
