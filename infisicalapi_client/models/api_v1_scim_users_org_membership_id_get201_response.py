...
class ApiV1ScimUsersOrgMembershipIdGet201Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1ScimUsersOrgMembershipIdGet201Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1ScimUsersOrgMembershipIdGet201Response:
        """Create an instance of ApiV1ScimUsersOrgMembershipIdGet201Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1ScimUsersOrgMembershipIdGet201Response.parse_obj(obj)

        _obj = ApiV1ScimUsersOrgMembershipIdGet201Response.parse_obj({
            ...
            "emails": [ApiV1ScimUsersGet200ResponseResourcesInnerEmailsInner.from_dict(_item) for _item in obj.get("emails")] if obj.get("emails") is not None else None,
            "display_name": obj.get("displayName"),
            "active": obj.get("active"),
            "groups": [ApiV1ScimUsersOrgMembershipIdGet201ResponseGroupsInner.from_dict(_item) for _item in obj.get("groups")] if obj.get("groups") is not None else None
        })
        return _obj
