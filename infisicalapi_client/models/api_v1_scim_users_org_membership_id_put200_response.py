...
class ApiV1ScimUsersOrgMembershipIdPut200Response(BaseModel):
    """
    ...
    emails: Annotated[List[ApiV1ScimUsersPostRequestEmailsInner], Field()] = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1ScimUsersOrgMembershipIdPut200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1ScimUsersOrgMembershipIdPut200Response:
        """Create an instance of ApiV1ScimUsersOrgMembershipIdPut200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1ScimUsersOrgMembershipIdPut200Response.parse_obj(obj)

        _obj = ApiV1ScimUsersOrgMembershipIdPut200Response.parse_obj({
