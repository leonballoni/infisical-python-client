...
class ApiV1AuthAwsAuthIdentitiesIdentityIdPostRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1AuthAwsAuthIdentitiesIdentityIdPostRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1AuthAwsAuthIdentitiesIdentityIdPostRequest:
        """Create an instance of ApiV1AuthAwsAuthIdentitiesIdentityIdPostRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1AuthAwsAuthIdentitiesIdentityIdPostRequest.parse_obj(obj)

        _obj = ApiV1AuthAwsAuthIdentitiesIdentityIdPostRequest.parse_obj({
            "sts_endpoint": obj.get("stsEndpoint") if obj.get("stsEndpoint") is not None else 'https://sts.amazonaws.com/',
