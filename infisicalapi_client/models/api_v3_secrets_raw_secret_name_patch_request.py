...
class ApiV3SecretsRawSecretNamePatchRequest(BaseModel):
    ...
    """
    workspace_id: StrictStr = Field(default=..., alias="workspaceId", description="The ID of the project to update the secret in.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV3SecretsRawSecretNamePatchRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV3SecretsRawSecretNamePatchRequest:
        """Create an instance of ApiV3SecretsRawSecretNamePatchRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV3SecretsRawSecretNamePatchRequest.parse_obj(obj)

        _obj = ApiV3SecretsRawSecretNamePatchRequest.parse_obj({
