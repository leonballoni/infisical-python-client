...
class ApiV1AuthOidcAuthIdentitiesIdentityIdPostRequest(BaseModel):
    ...
    """
    oidc_discovery_url: Annotated[str, StringConstraints(strict=True, min_length=1)] = Field(default=..., alias="oidcDiscoveryUrl", description="The URL used to retrieve the OpenID Connect configuration from the identity provider.")
    ...
    bound_issuer: Annotated[str, StringConstraints(strict=True, min_length=1)] = Field(default=..., alias="boundIssuer", description="The unique identifier of the identity provider issuing the JWT.")
