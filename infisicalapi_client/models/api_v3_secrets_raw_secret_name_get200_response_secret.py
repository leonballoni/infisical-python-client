...
class ApiV3SecretsRawSecretNameGet200ResponseSecret(BaseModel):
    """
    ...
    __properties = ["id", "_id", "workspace", "environment", "version", "type", "secretKey", "secretValue", "secretComment", "secretReminderNote", "secretReminderRepeatDays", "skipMultilineEncoding", "metadata", "createdAt", "updatedAt", "tags"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV3SecretsRawSecretNameGet200ResponseSecret:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV3SecretsRawSecretNameGet200ResponseSecret:
        """Create an instance of ApiV3SecretsRawSecretNameGet200ResponseSecret from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV3SecretsRawSecretNameGet200ResponseSecret.parse_obj(obj)

        _obj = ApiV3SecretsRawSecretNameGet200ResponseSecret.parse_obj({
            "id": obj.get("id"),
            "id": obj.get("_id"),
