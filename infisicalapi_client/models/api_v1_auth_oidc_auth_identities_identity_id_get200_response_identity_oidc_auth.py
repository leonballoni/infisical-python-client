...
class ApiV1AuthOidcAuthIdentitiesIdentityIdGet200ResponseIdentityOidcAuth(BaseModel):
    """
    ...
    oidc_discovery_url: StrictStr = Field(default=..., alias="oidcDiscoveryUrl")
    bound_issuer: StrictStr = Field(default=..., alias="boundIssuer")
    bound_audiences: StrictStr = Field(default=..., alias="boundAudiences")
    bound_claims: Optional[Any] = Field(default=None, alias="boundClaims")
    bound_subject: Optional[StrictStr] = Field(default=None, alias="boundSubject")
    created_at: datetime = Field(default=..., alias="createdAt")
    updated_at: datetime = Field(default=..., alias="updatedAt")
    ca_cert: StrictStr = Field(default=..., alias="caCert")
    __properties = ["id", "accessTokenTTL", "accessTokenMaxTTL", "accessTokenNumUsesLimit", "accessTokenTrustedIps", "identityId", "oidcDiscoveryUrl", "boundIssuer", "boundAudiences", "boundClaims", "boundSubject", "createdAt", "updatedAt", "caCert"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1AuthOidcAuthIdentitiesIdentityIdGet200ResponseIdentityOidcAuth:
    ...
    def to_dict(self):
        ...
        # set to None if bound_claims (nullable) is None
        # and __fields_set__ contains the field
        if self.bound_claims is None and "bound_claims" in self.__fields_set__:
            _dict['boundClaims'] = None

        # set to None if bound_subject (nullable) is None
        # and __fields_set__ contains the field
        if self.bound_subject is None and "bound_subject" in self.__fields_set__:
            _dict['boundSubject'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1AuthOidcAuthIdentitiesIdentityIdGet200ResponseIdentityOidcAuth:
        """Create an instance of ApiV1AuthOidcAuthIdentitiesIdentityIdGet200ResponseIdentityOidcAuth from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1AuthOidcAuthIdentitiesIdentityIdGet200ResponseIdentityOidcAuth.parse_obj(obj)

        _obj = ApiV1AuthOidcAuthIdentitiesIdentityIdGet200ResponseIdentityOidcAuth.parse_obj({
            "id": obj.get("id"),
            ...
            "bound_audiences": obj.get("boundAudiences"),
            "bound_claims": obj.get("boundClaims"),
            "bound_subject": obj.get("boundSubject"),
