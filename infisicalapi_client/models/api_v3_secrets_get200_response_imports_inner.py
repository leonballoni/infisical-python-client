...
class ApiV3SecretsGet200ResponseImportsInner(BaseModel):
    """
    ...
    secrets: Annotated[List[ApiV3SecretsGet200ResponseImportsInnerSecretsInner], Field()] = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV3SecretsGet200ResponseImportsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV3SecretsGet200ResponseImportsInner:
        """Create an instance of ApiV3SecretsGet200ResponseImportsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV3SecretsGet200ResponseImportsInner.parse_obj(obj)

        _obj = ApiV3SecretsGet200ResponseImportsInner.parse_obj({
            "secret_path": obj.get("secretPath"),
            "environment": obj.get("environment"),
            "folder_id": obj.get("folderId"),
            "secrets": [ApiV3SecretsGet200ResponseImportsInnerSecretsInner.from_dict(_item) for _item in obj.get("secrets")] if obj.get("secrets") is not None else None
        })
        return _obj
